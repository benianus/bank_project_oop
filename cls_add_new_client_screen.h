...
public:
    ...
    {
        if (!check_access_rights(cls_user::en_user_permissions::add_new_client_access))
        {
            return;
        }
        _draw_screen("\tAdd new client screen");
        ...
        {
            cout << "Client account number already exist, try another one\n";
            account_number = cls_ipunt_validation::read_string();
        }
        ...
        char answer = 'y';
        cout << "Are you sure to Add new account Y/N: ";
        cin >> answer;
        ...
        if (answer == 'y' || answer == 'Y')
        {
            ...
            case cls_bank_client::en_save_results::save_failed_empty_object:
                cout << "\nError, Empty account\n";
                break;
            case cls_bank_client::en_save_results::save_failed_account_number_exist:
                cout << "\nError client not save, because Client already exist, try another one\n";
                break;
            }
        }
    }
